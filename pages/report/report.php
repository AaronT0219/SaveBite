...
// 如果你的全局布局里已经开启 session/config，可只保留 require_once
...
<head>
  <meta charset="utf-8">
  <title>Track and Report</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- 你的项目如已引入 Bootstrap，这里可省略；此处仅使用其类名，不强依赖 -->
  ...
  <div class="mt-4 px-4">
      ...
      <div class="mb-5">
          ...
          <div class="progress" style="height: 30px;">
              <div id="progressBar" class="progress-bar bg-dark" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    if (window.initReportPage) window.initReportPage();
  });
</script>
</body>
</html>
