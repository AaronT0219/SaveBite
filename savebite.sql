...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2025 at 04:28 PM
...
(18, 'pending', NULL, 'home', NULL, '2025-10-12', 7, NULL, '11', '11111'),
(25, 'pending', NULL, '', '', '2025-10-14', 7, NULL, '', ''),
(27, 'pending', NULL, '', '', '2025-10-14', 8, NULL, '', '');
...
CREATE TABLE `fooditem` (
  ...
  `description` varchar(80) DEFAULT NULL,
  `status` enum('reserved','used','expired') NOT NULL,
...
(32, 'Produce', 'apple', 1, '2025-11-11', 'Fridge', '11', '', 7);
...
--
ALTER TABLE `donation`
  MODIFY `donation_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `fooditem`
--
ALTER TABLE `fooditem`
  MODIFY `foodItem_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
